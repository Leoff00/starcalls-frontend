<template>
  <section class="columns m-4 is-flex is-flex-direction-column is-justify-content-center is-align-items-center">
    <h2 class="is-size-3">Make a question!</h2>
